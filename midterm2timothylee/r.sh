...
g++ -c -m64 -Wall -fno-pie -no-pie -l statistics.lis -o statistics.o statistics.cpp -std=c++17

echo "Compile the C++ file reciprocal_sum.cpp"
g++ -c -m64 -Wall -fno-pie -no-pie -l reciprocal_sum.lis -o reciprocal_sum.o reciprocal_sum.cpp -std=c++17
...
g++ -m64 -fno-pie -no-pie -std=c++17 -o calc.out harmonic.o statistics.o reciprocal_sum.o isfloat.o
